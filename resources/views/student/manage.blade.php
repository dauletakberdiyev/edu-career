...
<main class="main">
        <div class="container-fluid">
          <div class="page__inner">
            ...
            <form method="POST" class="search-group" action="{{ route('student.search') }}">
            @csrf
                  ...
                  <tbody class="text-dark">
                    @foreach($users as $user)
                      <tr>
                        ...
                        <td>
                            <a href="{{ route('student.update', ['id' => $user->id]) }}" class="table-tool" @click.prevent="editstudent">
                            ...
                            <a href="#" class="table-tool"  @click.prevent="$emit('deletestudent', info)">
