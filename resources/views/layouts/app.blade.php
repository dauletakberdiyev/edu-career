        ...
        <div class="container-fluid">
          ...
          <nav class="header__menu">
            ...
            <a href="#" class="header__logo">
              <img src="./images/header/logo_beta.png" alt="logo_beta">
            </a>
            <div class="menu__right">
              ...
              <div class="ava__info" id="ava">
                ...
                <div class="ava__btn">
                  <button type="submit" onclick="window.location.href='/templates/login_pages/login.html' " >
                    Logout
                  </button>
                </div>
      ...
      <div class="sidebar">
        ...
        <ul class="sidebar__menu">
          ...
          <span class="link__svg">
            ...
            <li class="sidebar__item">
                <a class="sidebar__link {{ request()->routeIs('staff.*') ? 'active' : '' }}" href="{{ route('staff') }}">
          <span class="link__svg">
            ...
            <li class="sidebar__item">
                <a class="sidebar__link" href="/templates/general_pages/manage_companies.html">
          <span class="link__svg">
              <svg id="bold" enable-background="new 0 0 24 24" height="512" viewBox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><path d="m13.03 1.87-10.99-1.67c-.51-.08-1.03.06-1.42.39-.39.34-.62.83-.62 1.34v21.07c0 .55.45 1 1 1h3.25v-5.25c0-.97.78-1.75 1.75-1.75h2.5c.97 0 1.75.78 1.75 1.75v5.25h4.25v-20.4c0-.86-.62-1.59-1.47-1.73zm-7.53 12.88h-1.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h1.5c.414 0 .75.336.75.75s-.336.75-.75.75zm0-3h-1.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h1.5c.414 0 .75.336.75.75s-.336.75-.75.75zm0-3h-1.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h1.5c.414 0 .75.336.75.75s-.336.75-.75.75zm0-3h-1.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h1.5c.414 0 .75.336.75.75s-.336.75-.75.75zm5 9h-1.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h1.5c.414 0 .75.336.75.75s-.336.75-.75.75zm0-3h-1.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h1.5c.414 0 .75.336.75.75s-.336.75-.75.75zm0-3h-1.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h1.5c.414 0 .75.336.75.75s-.336.75-.75.75zm0-3h-1.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h1.5c.414 0 .75.336.75.75s-.336.75-.75.75z"></path><path d="m22.62 10.842-7.12-1.491v14.649h6.75c.965 0 1.75-.785 1.75-1.75v-9.698c0-.826-.563-1.529-1.38-1.71zm-2.37 10.158h-1.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h1.5c.414 0 .75.336.75.75s-.336.75-.75.75zm0-3h-1.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h1.5c.414 0 .75.336.75.75s-.336.75-.75.75zm0-3h-1.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h1.5c.414 0 .75.336.75.75s-.336.75-.75.75z"></path></svg>
          </span>
                    Manage company
                </a>
            </li>
          ...
          <span class="link__svg">
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" fill="currentColor">
              <g><g><polygon points="320,0 320,128 448,128     "></polygon></g></g><g>
                <g>
            ...
            <li class="sidebar__item">
                <a href="/templates/general_pages/manage_registration.html" class="sidebar__link">
                <span class="link__svg">
                    <svg height="512pt" viewBox="0 -20 512 512" width="512pt" xmlns="http://www.w3.org/2000/svg" fill="currentColor"><path d="m119 161c-22.054688 0-40 17.945312-40 40v151c0 22.054688 17.945312 40 40 40h76c22.054688 0 40-17.945312 40-40v-151c0-22.054688-17.945312-40-40-40zm76 191h-76v-151h76l.023438 151s-.003907 0-.023438 0zm236-75c0 11.046875-8.953125 20-20 20h-116c-11.046875 0-20-8.953125-20-20s8.953125-20 20-20h116c11.046875 0 20 8.953125 20 20zm0 76c0 11.046875-8.953125 20-20 20h-116c-11.046875 0-20-8.953125-20-20s8.953125-20 20-20h116c11.046875 0 20 8.953125 20 20zm0-152c0 11.046875-8.953125 20-20 20h-116c-11.046875 0-20-8.953125-20-20s8.953125-20 20-20h116c11.046875 0 20 8.953125 20 20zm21-201h-392c-33.085938 0-60 26.914062-60 60v332c0 44.113281 35.886719 80 80 80h352c44.113281 0 80-35.886719 80-80 0-11.046875-8.953125-20-20-20s-20 8.953125-20 20c0 22.054688-17.945312 40-40 40h-352c-22.054688 0-40-17.945312-40-40v-271h432v171c0 11.046875 8.953125 20 20 20s20-8.953125 20-20v-232c0-33.085938-26.914062-60-60-60zm-81 40c11.027344 0 20 8.972656 20 20s-8.972656 20-20 20-20-8.972656-20-20 8.972656-20 20-20zm100 20c0 11.027344-8.972656 20-20 20s-20-8.972656-20-20 8.972656-20 20-20 20 8.972656 20 20zm-431 0c0-11.027344 8.972656-20 20-20h254.441406c-2.222656 6.261719-3.441406 12.988281-3.441406 20 0 7.386719 1.347656 14.460938 3.800781 21h-274.800781zm0 0"></path></svg>
                </span>
                    Manage registration
                </a>
            </li>
            ...
            <li class="sidebar__item">
                <a href="/templates/general_pages/manage_posts.html" class="sidebar__link">
                  <span class="link__svg">
                      <svg id="Capa_1" fill="currentColor" enable-background="new 0 0 508 508" height="512" viewBox="0 0 508 508" width="512" xmlns="http://www.w3.org/2000/svg"><g><path d="m470.958 169.333h-433.916c-20.32 0-37.042 16.722-37.042 37.042v264.583c0 20.32 16.722 37.042 37.042 37.042h433.917c20.32 0 37.042-16.722 37.042-37.042v-264.583c-.001-20.32-16.723-37.042-37.043-37.042zm-26.458 100.542v137.583c0 20.32-16.51 37.042-37.042 37.042h-116.416c-20.532 0-37.042-16.722-37.042-37.042v-137.583c0-20.32 16.51-37.042 37.042-37.042h116.417c20.531 0 37.041 16.722 37.041 37.042zm-248.708 79.375h-116.417c-8.678 0-15.875-7.197-15.875-15.875s7.197-15.875 15.875-15.875h116.417c8.678 0 15.875 7.197 15.875 15.875s-7.197 15.875-15.875 15.875zm15.875 47.625c0 8.678-7.197 15.875-15.875 15.875h-116.417c-8.678 0-15.875-7.197-15.875-15.875s7.197-15.875 15.875-15.875h116.417c8.678 0 15.875 7.197 15.875 15.875zm-15.875-111.125h-116.417c-8.678 0-15.875-7.197-15.875-15.875s7.197-15.875 15.875-15.875h116.417c8.678 0 15.875 7.197 15.875 15.875s-7.197 15.875-15.875 15.875z"></path><path d="m470.958 0h-433.916c-20.426 0-37.042 16.616-37.042 37.042v52.917c0 20.425 16.616 37.041 37.042 37.041h433.917c20.425 0 37.041-16.616 37.041-37.042v-52.916c0-20.426-16.616-37.042-37.042-37.042z"></path></g></svg>
                  </span>
                    Posts
                </a>
            </li>
            ...
            <li class="sidebar__item">
                ...
                <span class="link__svg">
                  <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" fill="currentColor"><g><g><g><path d="M462.75,210.479c-3.979-1.656-8.583-0.74-11.625,2.313l-65.854,65.833c-4.479,4.49-10.146,7.51-16.333,8.75
                    ...
                    <path d="M471.167,64c-10.771,0-21.292,4.365-28.875,11.958L312.458,205.771c-1.5,1.49-2.5,3.385-2.917,5.448l-10.667,53.354
                      ...
                      C512,82.313,493.688,64,471.167,64z M454.249,149.332l-27.587-27.587l15.083-15.083l27.589,27.589L454.249,149.332z"></path></g></g></g>
                  </svg>
                </span>
                    Feedback reply
                </a>
